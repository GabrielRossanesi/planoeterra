...
export function MobileTabBar() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-ink-950 pb-safe text-mineral-100 shadow-[0_-14px_40px_rgba(0,0,0,.32)] lg:hidden"
    >
      <div className="mx-auto grid h-[4.25rem] max-w-lg grid-cols-5 items-stretch px-1">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-1 rounded-2xl text-[#43c07e] outline-none transition focus-visible:ring-2 focus-visible:ring-mineral-300 active:text-[#5ad494]"
        >
          <WhatsAppIcon />
